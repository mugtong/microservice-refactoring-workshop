...
import app.anne.give.application.AcceptGiveService;
...
public class GiveController {
    ...
    private final AcceptGiveService acceptGiveService;
    ...
    public ResponseEntity<?> acceptGiveRequest(@RequestBody @Valid AcceptGiveRequest request) {
        ...
        acceptGiveService.acceptGiveRequest(parsedGiveId, new OwnerId(request.getOwnerId()));
        return ResponseEntity.ok().build();
    }
